...
Your assistant builds a private knowledge base of your projects, documents, meetings, people, and decisions, and refreshes it automatically every night. 
...
### Phase 4 — Graph & Ontology · *see how everything connects*
Your knowledge becomes a navigable, color-coded map, and it keeps its own structure current automatically. You can see how projects, people, and decisions relate, and surface the non-obvious connection between two things you already know.
**What it does for you:** find the non-obvious link between two things you already know; navigate years of context visually. 
**The why:** the value is in the connections, and this makes them visible and self-maintaining.
...
- **Obsidian** (free) — the local notes app that is the home of your memory, from Phase 1 on. The coach helps you install it.
...
templates/       ← files the coach fills in (memory rulebook, vault scaffold, voice card, ontology seed)
